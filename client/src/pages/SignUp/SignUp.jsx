...
const SignUp = () => {
    ...
    return (
        <div
            className="h-full bg-gradient-to-tl from-green-900 to-indigo-900 w-full py-16 px-4"
            style={{ height: '100vh' }}
        >
            <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
                <p className="text-light flex items-center mb-6 text-3xl font-semibold">
                    <img
                        className="signin-logo w-8 h-8 mr-2"
                ...
                <div className="w-full bg-white login-form-container shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <form
                            ...
                            className="text-end space-y-4 md:space-y-6"
                        >
                            <div>
                                <label
                                    htmlFor="email"
                            ...
                            {registered ? (
                                <div className="registered">
                                    <p>
                                        ثبت نام شما با موفقیت انجام شد در حال
                                        انتقال به پنل
                                    </p>
                                </div>
                            ) : null}
