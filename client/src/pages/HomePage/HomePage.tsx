                ...
                <div className="mx-auto max-w-2xl py-32 ">
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                            ...
                            <a style={{position: 'relative', left:'-2px'}} href="#" className="font-semibold text-indigo-600">
                                <span className="absolute inset-0" aria-hidden="true"/>
                                بیشتر بخوانید<span aria-hidden="true">&rarr;</span>
                            </a>
                        </div>
                    </div>
                    <div className="text-center">
                        <h3 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                            بیمه یاران؛ مدیریت و خرید آنلاین بیمه
                        </h3>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            در چند دقیقه، بیمه مورد نظر خود را با سامانه هوشمند بیمه یاران، خریداری کنید و از خسارات در امان باشید
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <Button onClick={() => {
                               navigate("/signin")
                            }
                            } className="m-btn" variant="contained" startIcon={<AddIcon />}>ثبت درخواست</Button>
                        </div>
                    </div>
                </div>
                <div
