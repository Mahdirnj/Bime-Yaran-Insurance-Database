        ...
        <div className="mt-60 flex-col p-20 branch-items-container container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 pt-6 gap-8">
            {branches.map((branch) => (
                <div
                    ...
                    className="rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 rounded border-gray-300  dark:border-gray-700 "
                >
    ...
    return (
        <div>
            <Box sx={{ display: 'flex' }}>
                ...
                <div
                    style={{ position: 'absolute', top: '20%', left: '34.5%' }}
                >
                    <Button
