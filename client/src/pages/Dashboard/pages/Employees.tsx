...
const Employees = () => {
    ...
    useEffect(() => {
        Axios.post("http://localhost:3001/employees").then(
            (response) => {
            employees = []
                    ...
                    <TableBody>
                        {employees.map((employee) => (
                            ...
                            >
                                ...
                                <TableCell align="center"><p>{employee.employee_name}</p></TableCell>
                ...
                <DialogContent>
                    <div className="md:flex items-center">
                        <div className="md:w-72 flex flex-col contact-item">
                            ...
                            <input onChange={(e) => {setEmpId(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="1" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label className="text-end leading-none text-gray-800">نام کارمند</label>
                            <input onChange={(e) => {setEmpName(e.target.value)}} tabIndex={0} aria-label="Please input name" type="name" className="text-end leading-none text-gray-900 p-3 mt-4 bg-gray-100 placeholder-gray-300" placeholder="محمد ندایی " />
                        </div>
                    ...
                    <div className="md:flex items-center mt-8">
                        <div className="md:w-72 flex flex-col">
                            ...
                            <input onChange={(e) => {setnNum(e.target.value)}} tabIndex={0} role="input" aria-label="Please input company name" type="name" className="text-end leading-none text-gray-900 p-3 mt-4 bg-gray-100 placeholder-gray-300 " placeholder="۹۹۱۱۹۹۹" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label className="text-end leading-none text-gray-800">حقوق</label>
                            <input onChange={(e) => {setSalary(e.target.value)}} tabIndex={0} aria-label="Please input name" type="name" className="text-end leading-none text-gray-900 p-3 mt-4 bg-gray-100 placeholder-gray-300" placeholder="۵۰۰۰۰۰۰" />
                        </div>
                    </div>
                    <div className="mt-10" style={{textAlign: 'end'}}>
                        <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">کد شعبه فعالیت</label>
                        <input onChange={(e) => {setBranch(e.target.value)}} tabIndex={0} aria-label="Please input name" type="name" className="text-end leading-none text-gray-900 p-3 mt-2 bg-gray-100 placeholder-gray-300" placeholder="۲" />
                    </div>
                    {wrongInfo ?
                ...
                <DialogContent>
                    <div className="md:flex items-center">
                        <div className="md:w-72 flex flex-col contact-item">
                            ...
                            <input onChange={(e) => {setUserId(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="1" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <label className="text-end leading-none text-gray-800">نام کارمند</label>
                            <input onChange={(e) => {setEmpName(e.target.value)}} tabIndex={0} aria-label="Please input name" type="name" className="text-end leading-none text-gray-900 p-3 mt-4 bg-gray-100 placeholder-gray-300" placeholder="محمد ندایی " />
