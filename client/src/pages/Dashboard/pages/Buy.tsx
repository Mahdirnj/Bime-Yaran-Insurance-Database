        ...
        if (
            ...
            for (var i = 0; i < 10; i++) {
                age_t = age_t
                    ...
                    .replace(englishNumbers[i], String(i))
            }
            for (var i = 0; i < 10; i++) {
                area_t = area_t
                    .replace(persianNumbers[i], String(i))
                    ...
                    if (response.data == 'E') {
                        ...
                        if (insurance_id == 3) {
                            ...
                            if (carInsuranceType == 'بدنه') {
                                ...
                                if (vehType == 'سواری') {
                                    insurance_price =
                                        body.car * Number(carValue)
                                } else if (vehType == 'موتور سیکلت') {
                                    insurance_price =
                                        body.motorcycle * Number(carValue)
                                } else if (vehType == 'کامیون') {
                                    insurance_price =
                                        body.truck * Number(carValue)
                                } else if (vehType == 'اتوبوس') {
                                    insurance_price =
                                        body.bus * Number(carValue)
                                }
                            } else {
                                insurance_type = 2
                                if (vehType == 'سواری') {
                                    insurance_price =
                                        third_party.car * Number(carValue)
                                } else if (vehType == 'موتور سیکلت') {
                                    insurance_price =
                                        third_party.motorcycle *
                                        Number(carValue)
                                } else if (vehType == 'کامیون') {
                                    insurance_price =
                                        third_party.truck * Number(carValue)
                                } else if (vehType == 'اتوبوس') {
                                    insurance_price =
                                        third_party.bus * Number(carValue)
                                }
                            }
                            const currentDate = new Date()
                            const year = currentDate.getFullYear()
                        ...
                        Axios.post('http://localhost:3001/add-transaction', {
                            ...
                            console.log(response)
                            Axios.post(
                                'http://localhost:3001/check-transaction',
                                {
                                    user_id: user_id,
                                    insurance_id: insurance_id,
                                }
                                ...
                                Axios.post(
                                    'http://localhost:3001/complete-contract',
                                    {
                                        client_id: cli_id,
                                        insurance_id: insurance_id,
            ...
            <div className="buy-wrapper">
                {registered ? (
                    <div className="buy-container">
                        <div className="md:w-72 flex flex-col buy-item">
                            <label className="text-end leading-none text-gray-800">
                                نام خانوادگی{' '}
                            </label>
                            <input
                                disabled
                ...
                <div className="buy-container">
                    ...
                    <div className="md:w-72 flex flex-col buy-item">
                        <label
                            htmlFor="countries"
                            className="text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                        >
                    ...
                    >
                        <Box sx={style}>
                            ...
                            <p className="text-end">
                                ...
                                <span>
                                    {' '}
                                    خریداری کردید برای مشاهده وضعیت بیمه به
                                    داشبورد ( بخش بیمه های من ) مراجعه نمایید{' '}
                                </span>
                            </p>
