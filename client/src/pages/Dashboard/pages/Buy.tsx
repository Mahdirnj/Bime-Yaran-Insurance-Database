            ...
            <div className="buy-wrapper">
                    {registered ?
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                ...
                                <input disabled value={fname}  onChange={(e) => {setFname(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">نام</label>
                                <input disabled value={name} onChange={(e) => {setName(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                        </div>
                        :
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">نام خانوادگی </label>
                                <input value={fname} onChange={(e) => {setFname(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">نام</label>
                                <input value={name} onChange={(e) => {setName(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                        </div>
                        }
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                ...
                                <input value={phone}  onChange={(e) => {setPhone(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">آدرس</label>
                                <input value={address}  onChange={(e) => {setAddress(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                        </div>
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">تاریخ تولد</label>
                                <input value={birthday}  onChange={(e) => {setBirthday(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="date" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="****" />
                            </div>
                            <div className="md:w-72 flex flex-col buy-item">
                                <label htmlFor="countries" className="text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white">نوع بیمه را انتخاب کنید</label>
                                <select onChange={(e) => {setType(e.target.value)}}  id="countries"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option style={{textAlign:'end'}} selected>انتخاب نوع بیمه</option>
                                    {insurances.map((insurance) => (
                                        <option key={insurance.insurance_id} style={{textAlign:'end'}}>{insurance.insurance_name}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                {type == "بیمه عمر" ?
                    <div className="buy-container">
                        <div className="md:w-72 flex flex-col buy-item">
                            ...
                            <input value={age}  onChange={(e) => {setAge(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                        </div>
                    </div>
                    : null
                }
                {type == "بیمه آتش" ?
                    <div className="buy-container">
                        <div className="md:w-72 flex flex-col buy-item">
                            ...
                            <input value={area}  onChange={(e) => {setArea(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                        </div>
                    </div>
                    : null
                }
                {type == "بیمه اتوموبیل" ?
                    <div>
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                ...
                                <input value={carValue}  onChange={(e) => {setCarValue(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                            <div className="md:w-72 flex flex-col buy-item">
                                <label className="text-end leading-none text-gray-800">شماره شناسایی وسیله نقلیه</label>
                                <input value={carId}  onChange={(e) => {setCarId(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="name" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="" />
                            </div>
                        </div>
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                <label htmlFor="countries" className="text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white">نوع وسیله نقلیه را انتخاب کنید</label>
                                <select onChange={(e) => {setVehType(e.target.value)}}  id="countries"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option style={{textAlign:'end'}} selected>انتخاب نوع وسیله نقلیه</option>
                            ...
                            <div className="md:w-72 flex flex-col buy-item">
                                <label htmlFor="countries" className="text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white">نوع بیمه وسیله نقلیه را انتخاب کنید</label>
                                <select onChange={(e) => {setCarInsuranceType(e.target.value)}}  id="countries"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option style={{textAlign:'end'}} selected>انتخاب نوع بیمه وسیله نقلیه</option>
                    ...
                    : null
                        ...
                        <div className="buy-container">
                            <div className="md:w-72 flex flex-col buy-item">
                                <label htmlFor="countries" className="text-end block mb-2 text-sm font-medium text-gray-900 dark:text-white">شعبه بیمه را انتخاب کنید</label>
                                <select onChange={(e) => {setBranch(e.target.value)}}  id="countries"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option style={{textAlign:'end'}} selected>انتخاب شعبه</option>
                                    {branches.map((branch) => (
                                        <option key={branch.branch_id} style={{textAlign:'end'}}>{branch.branch_name}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                ...
                <div className="buy-btn-container">
                    <Button onClick={handleBuy}
                            className="m-btn buy-btn" variant="contained" color="info" startIcon={<AddIcon />}>ثبت سفارش</Button>
                </div>
                {wrongInfo ?
                    ...
                    <Modal
                        open={rightInfo}
                        onClose={handleRightInfoClose}
                        aria-labelledby="modal-modal-title"
                        aria-describedby="modal-modal-description"
                    >
                        <Box sx={style}>
                            <div className="success-icon">
                                <Avatar sx={{ bgcolor: green[400] }}><CheckBox /></Avatar>
                            </div>
