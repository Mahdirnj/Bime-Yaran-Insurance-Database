        ...
        <div>
            ...
            <div className="password-container">
                <div className="md:w-72 flex flex-col contact-item">
                    ...
                    <input  onChange={(e) => {setPassword(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="password" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="****" />
                </div>
                <div className="md:w-72 flex flex-col contact-item">
                    <label className="text-end leading-none text-gray-800"> رمز عبور</label>
                    <input onChange={(e) => {setRepeatPassword(e.target.value)}} tabIndex={0} aria-label="Please input email address" type="password" className="text-end leading-none text-gray-900 p-3  mt-4 bg-gray-100 placeholder-gray-300" placeholder="****" />
                </div>
            </div>
            <div className="password-btn-container">
                <Button onClick={handleChangePassword}
                        className="m-btn password-btn" variant="contained" color="info" startIcon={<VpnKeyIcon />}>تغییر رمز عبور</Button>
            </div>
            {wrongInfo ?
