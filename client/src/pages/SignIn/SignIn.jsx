                    ...
                    <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                        <section className="bg-gray-50 dark:bg-gray-900">
                            <div
                                ...
                                <div
                                    className="w-full bg-white login-form-container shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                                    <a className="home-btn" onClick={() => {
                                        navigate("/")
                                    }
                                    }>
                                        <HomeIcon />
