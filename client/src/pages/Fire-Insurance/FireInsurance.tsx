                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto  sm:text-center">
                        ...
                        <p className="text-end mt-6 text-lg leading-8 text-gray-600">
                            ایران یکی از ۱۰ کشور آسیب پذیر جهان از نظر رخداد حوادث طبیعی محسوب می‌شود و متاسفانه آتش‌سوزی نیز یکی از حوادث رایج در کشور ماست. به‌طوری که روزانه بیش از 50 حادثه آتش سوزی در کشور رخ می‌دهد. چنین حوادثی علاوه بر خسارت‌های جانی دردناک ، خسارت‌های مالی فراوانی هم برای افراد به بار می‌آورند                        </p>
                        <p className="text-end mt-6 text-lg leading-8 text-gray-600">
                            همین موضوع باعث شده تا لزوم بیمه اموال برای جبران این خسارات بیش از پیش احساس شود. برای جبران خسارت‌های مالی ناشی از حوادث مرتبط با آتش‌سوزی شرکت های بیمه محصولی به‌نام بیمه آتش سوزی را  ارائه می‌کنند
                        </p>
                        <p className="text-end mt-6 text-lg leading-8 text-gray-600">
                    ...
                    <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-2 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                        ...
                        <div className="p-8 sm:p-10 lg:flex-auto">
                            ...
                            <p className="text-end mt-6 text-base leading-7 text-gray-600">
                                موقع خرید بیمه زلزله و آتش ‌سوزی بهتر است با توجه به موقعیت و متراژ ساختمان و همچنین نوع کاربری آن پوشش‌های اضافی مناسب را به بیمه نامه اضافه کنید                            </p>
