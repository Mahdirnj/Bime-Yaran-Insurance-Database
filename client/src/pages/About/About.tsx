            ...
            >
                ...
                <div className="text-end mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mt-20 mx-auto max-w-6xl lg:mx-0">
                        <h2 className="text-end text-4xl font-bold tracking-tight text-white sm:text-6xl">
                            درباره ما
                        </h2>
                        <p className="text-end mt-6 text-lg leading-8 text-gray-300">
                            قصد خرید بیمه را دارید؟ نگران فرآیند‌های سخت خرید و
                            استفاده از بیمه نباشید. بیمه یاران به عنوان همراهی
                            آگاه در کنار شما است تا بتوانید با دانش کافی بهترین
                            بیمه‌ را انتخاب کنید
                        </p>
                        <p className="text-end mt-6 text-lg leading-8 text-gray-300">
                            بیمه یاران در تمام مراحل خرید و استفاده از بیمه
                            همراه شما است. به کمک بیمه یاران می‌توانید قبل از
                            خرید، درباره انواع مختلف بیمه و پوشش‌های آن اطلاعات
                            کامل را کسب کنید و سپس خدمات و قیمت‌های شرکت‌های
                            گوناگون بیمه‌ای را با یکدیگر مقایسه نمایید. فرآیند
                            خرید با بیمه یاران بسیار سریع و ساده انجام می‌شود.
                            تمام مراحل آنلاین است و هیچ نیازی به مراجعه حضوری
                            ندارید و این‌گونه در زمان صرفه‌جویی می‌کنید
                        </p>
                    </div>
