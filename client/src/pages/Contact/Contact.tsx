        ...
        <div>
            ...
            <div className="bg-gradient-to-b from-purple-600 to-indigo-700 h-96 w-full">
                ...
                <div className="contact-form w-full flex items-center justify-center my-12">
                    <div
                        className="absolute top-40 bg-white shadow py-8 lg:px-28 px-8"
                        ...
                        <div>
                            <div className="w-full flex flex-col mt-8">
                                ...
                                <textarea
                                    ...
                                    role="textbox"
                                    type="name"
                                    className="h-36 text-end leading-none text-gray-900 p-3 mt-4 bg-gray-100 placeholder-gray-300 resize-none"
                                    placeholder="..."
                                />
                            </div>
                        </div>
                        <p className="text-end text-xs leading-3 text-gray-600 mt-4">
                            با کلیک بر روی دکمه ی ارسال، با قوانین صندوق پستی
                            بیمه یاران موافقت می کنید
                        </p>
                        <div
