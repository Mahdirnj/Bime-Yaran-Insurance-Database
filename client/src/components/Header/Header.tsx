            ...
            >
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    ...
                    <Popover className="relative">
                        <Popover.Button
                            style={{ color: props.color }}
                            className="popover-btn inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900"
                        >
                            <span
                                style={{ color: props.color }}
                                className="text-lg leading-6 text-gray-900"
                                    ...
                                    <div className="p-4">
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="mt-1 text-gray-600">
                                                    بیمه اشخاص یکی از مهمترین
                                                    شاخه های رفاه اجتماعی محسوب
                                                    می شود
                                                </p>
                                            </div>
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="mt-1 text-gray-600">
                                                    این گروه بیمه را می‌توان به
                                                    دو بیمه بدنه و بیمه شخص ثالث
                                                    و سرنشین تقسیم کرد
                                                </p>
                                            </div>
                                            <div className="mt-1 flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="mt-1 text-gray-600">
                                                    موضوع بیمه آتش ‌سوزی، تأمین
                                                    خسارت و جبران زیان‌های مالی
                                                    و مادی است
                                                </p>
                                            </div>
                                            <div className="mt-1 flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
